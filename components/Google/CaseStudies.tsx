...
export const CaseStudies: React.FC = () => {
  ...
  return (
    <section
      className="hidden lg:block relative w-full h-auto lg:h-[1542px]"
      role="main"
      aria-label="Case Studies Section"
    >
      <div className="hidden lg:block h-auto lg:h-[1542px] bg-[#0c0c0f] overflow-hidden py-8 lg:py-0">
        <div className="relative w-full lg:w-[1780px] h-auto lg:h-[1368px] top-0 lg:top-[93px] left-0 lg:left-[-172px] px-4 lg:px-0">
          ...
          <div className="flex flex-col w-full max-w-[1128px] items-start gap-6 lg:gap-[23px] relative lg:absolute top-0 left-0 lg:left-[328px]">
