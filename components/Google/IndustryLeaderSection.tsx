...
export const IndustryLeadersSection : React.FC = () => {
  ...
  return (
    <section
      className="flex flex-col w-[1168px] items-center gap-[95px] relative flex-[0_0_auto]"
      role="region"
      aria-label="Industry Leaders Statistics"
    >
      <div className="relative self-stretch w-full h-[314px]">
        <img
        ...
        {statsData.map((stat) => (
          <div
            key={stat.id}
            className="inline-flex items-end gap-3 p-5 absolute bg-grey-50 rounded-[20px]"
          ...
          >
            ...
            >
              {stat.bgColor ? (
                <>
                  <div className="relative self-stretch mt-[-1.00px] [font-family:'Urbanist',Helvetica] font-normal text-neutral-800 text-base tracking-[0] leading-[19.2px]">
                    {stat.title}
                  </div>
                  <div className="relative self-stretch [font-family:'Urbanist',Helvetica] font-semibold text-neutral-900 text-[21px] tracking-[0] leading-[25.2px]">
                    {stat.value}
                  </div>
                </>
              ) : (
                <>
                  <div className="relative self-stretch mt-[-1.00px] [font-family:'Urbanist',Helvetica] font-semibold text-neutral-900 text-[22px] tracking-[0] leading-[26.4px]">
                    {stat.value}
                  </div>
                  <div className="relative self-stretch [font-family:'Urbanist',Helvetica] font-normal text-neutral-800 text-base tracking-[0] leading-[19.2px]">
                    {stat.title}
                  </div>
                </>
              )}
        ...
        <article className="flex flex-col w-[443px] items-center gap-4 px-5 py-4 absolute top-0 left-[359px] bg-neutral-0 rounded-3xl shadow-[7px_8px_54.8px_#0f202840]">
          <header className="flex flex-col items-center gap-6 relative self-stretch w-full flex-[0_0_auto]">
            <div className="inline-flex flex-col items-center justify-center gap-3 relative flex-[0_0_auto]">
              <h3 className="relative w-fit mt-[-1.00px] [font-family:'Urbanist',Helvetica] font-semibold text-neutral-900 text-xl tracking-[0] leading-[34px] whitespace-nowrap">
                Campaign Markets
              </h3>

              <p className="relative w-fit [font-family:'Urbanist',Helvetica] font-normal text-neutral-800 text-sm tracking-[0] leading-[20.3px] whitespace-nowrap">
                  ...
                  <div className="flex items-center justify-between px-3 py-[13px] relative self-stretch w-full flex-[0_0_auto] bg-neutral-0 rounded-2xl">
                    <div className="inline-flex items-center gap-2 relative flex-[0_0_auto]">
                      ...
                      <div className="inline-flex items-center justify-center gap-0.5 relative flex-[0_0_auto]">
                        <div className="relative w-fit [font-family:'Urbanist',Helvetica] font-medium text-neutral-900 text-base tracking-[0] leading-[34px] whitespace-nowrap">
                          {campaign.name}
                        </div>
                    ...
                    <div className="relative w-fit [font-family:'Urbanist',Helvetica] font-medium text-neutral-800 text-base tracking-[0] leading-[34px] whitespace-nowrap">
                      {campaign.price}
                    </div>
                  </div>
                </div>
          ...
          <button className="flex h-12 items-center justify-around gap-[55px] px-3 py-[18px] relative self-stretch w-full bg-neutral-900 rounded-[100px] hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-900 transition-opacity">
            <span className="relative w-fit mt-[-1.00px] [font-family:'Urbanist',Helvetica] font-medium text-neutral-0 text-base tracking-[0] leading-[34px] whitespace-nowrap">
              OPTIMIZE NOW
            </span>
          </button>
        </article>

        <div className="inline-flex flex-col items-start gap-2 p-6 absolute top-[35px] left-[837px] bg-neutral-0 rounded-3xl border-[1.5px] border-solid border-grey-100 shadow-[20px_20px_42.1px_#1c3f3a26]">
        ...
        <div className="inline-flex flex-col items-start gap-2 px-6 py-5 absolute top-8 left-[93px] bg-neutral-0 rounded-3xl">
