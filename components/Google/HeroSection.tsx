...
const HeroSection: NextPage<HeroSectionType> = ({ className = "" }) => {
  ...
  return (
    <div className="w-full bg-neutral-900 h-auto min-h-[400px] md:min-h-[480px] lg:min-h-[560px]">
      <div className="max-w-[1128px] mx-auto px-4 md:px-8 lg:px-0 w-full">
        ...
        <div className="relative flex flex-col items-center px-4 md:px-8 lg:px-[157px] py-8 md:py-10 lg:py-16 mb-0">
          {/* Header Section */}
          <div className="flex w-full max-w-[766px] flex-col justify-center items-center gap-6 md:gap-8 lg:gap-10">
            <div className="flex w-full max-w-[702px] flex-col justify-center items-center gap-2 md:gap-3 lg:gap-4">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row justify-center items-stretch sm:items-center gap-3 md:gap-4 lg:gap-[13px] w-full max-w-[520px] px-4 sm:px-0">
