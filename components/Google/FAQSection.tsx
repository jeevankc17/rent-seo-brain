  ...
  const [faqItems, setFaqItems] = useState<FAQItem[]>([
    {
      ...
      answer:
        "The cost of running Google Ads depends on several factors — such as your industry, competition, target audience, and campaign goals. Some industries with high competition (like legal or finance) may require a larger budget, while others can start small and scale.",
      isExpanded: true,
    },
    {
      id: 2,
    ...
    {
      id: 4,
      question: "What makes your Google Ads service different from others?",
      isExpanded: false,
    },
  ]);
              ...
              >
                ...
                >
                  <img
                    ...
                    src={
                      item.isExpanded
                        ? "/Google/ca/line-rounded-chevron-down.svg"
                        : "/Google/ca/line-rounded-chevron-right-2.svg"
                    }
                  />
                </button>
              </div>
