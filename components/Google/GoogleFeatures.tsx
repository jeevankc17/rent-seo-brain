...
const GoogleFeatures = () => {
  return (
    <div className="flex w-full max-w-[1129px] mx-auto flex-col items-center gap-[83px] relative py-[86px] min-h-[1154px] bg-neutral-900">
      {/* Header Section */}
      <div className="flex w-[601px] flex-col justify-center items-center gap-4 relative">
        {/* Badge */}
        <div className="flex w-[203px] px-[10px] py-[5px] justify-center items-center gap-[6px] rounded-[45px] bg-[#12579C] relative">
          <svg 
            width="15" 
            height="15" 
            viewBox="0 0 15 15" 
        ...
        <div className="flex h-[176px] flex-col justify-center items-center gap-4 self-stretch relative">
          ...
          <p className="self-stretch text-[#EBEDEF] text-center font-urbanist text-[16px] font-normal leading-[23px]">
      ...
      <div className="h-[846px] self-stretch relative">
        {/* Connecting Lines */}
        <svg 
          className="w-[850px] h-[161px] absolute left-[139px] top-[483px]" 
          width="852" 
          height="163" 
          viewBox="0 0 852 163" 
          fill="none" 
        ...
        <svg 
          className="w-[850px] h-[161px] absolute left-[136px] top-[181px]" 
          width="852" 
          height="163" 
          viewBox="0 0 852 163" 
          fill="none" 
        ...
        <svg 
          className="w-[550px] h-[161px] absolute left-[136px] top-[21px]" 
          width="551" 
          height="163" 
          viewBox="0 0 551 163" 
          fill="none" 
        ...
        <svg 
          className="w-[850px] h-[161px] absolute left-[136px] top-[322px]" 
          width="852" 
          height="163" 
          viewBox="0 0 852 163" 
          fill="none" 
        ...
        <svg 
          className="w-[850px] h-[161px] absolute left-[139px] top-[624px]" 
          width="852" 
          height="163" 
          viewBox="0 0 852 163" 
          fill="none" 
        ...
        {/* Background Numbers */}
        <div className="absolute left-[107px] top-[17px] w-[74px] h-[23px] text-[rgba(67,162,255,0.15)] font-urbanist text-[200px] font-black leading-[23px]">1</div>
        <div className="absolute left-[903px] top-[174px] w-[118px] h-[88px] text-[rgba(67,162,255,0.15)] font-urbanist text-[200px] font-black leading-[23px]">2</div>
        <div className="absolute left-[109px] top-[335px] w-[105px] h-[23px] text-[rgba(67,162,255,0.15)] font-urbanist text-[200px] font-black leading-[23px]">3</div>
        <div className="absolute left-[912px] top-[488px] w-[120px] h-[23px] text-[rgba(67,162,255,0.15)] font-urbanist text-[200px] font-black leading-[23px]">4</div>
        <div className="absolute left-[122px] top-[657px] w-[118px] h-[23px] text-[rgba(67,162,255,0.15)] font-urbanist text-[200px] font-black leading-[23px]">5</div>
        <div className="absolute left-[938px] top-[763px] w-[111px] h-[23px] text-[rgba(67,162,255,0.15)] font-urbanist text-[200px] font-black leading-[23px]">6</div>

        {/* Step 1 - Discovery */}
        <div className="flex w-[205px] flex-col items-center gap-[18px] absolute left-0 top-0 h-[128px]">
          <div className="flex pr-[19px] justify-center items-center gap-[12px] rounded-[35px] border border-[#1D8FFF] bg-[#22384C]">
            ...
            <span className="text-white font-urbanist text-[20px] font-normal leading-[23px]">Discovery</span>
          </div>
          <p className="self-stretch text-[#C1C7CD] text-center font-urbanist text-[14px] font-normal leading-[23px]">
            Understand your goals, audience, and competitors to plan the right strategy.
          </p>
        </div>

        {/* Step 2 - Keyword Research */}
        <div className="flex w-[234px] flex-col items-center gap-[18px] absolute left-[894px] top-[169px] h-[105px]">
          <div className="flex pr-[19px] justify-center items-center gap-[12px] self-stretch rounded-[35px] border border-[#1D8FFF] bg-[#22384C]">
            ...
            <span className="text-white font-urbanist text-[20px] font-normal leading-[23px]">Keyword Research</span>
          </div>
          <p className="self-stretch text-[#C1C7CD] text-center font-urbanist text-[14px] font-normal leading-[23px]">
        ...
        <div className="flex w-[222px] flex-col justify-center items-center gap-[18px] absolute left-0 top-[322px] h-[128px]">
          <div className="flex pr-[19px] justify-center items-center gap-[12px] self-stretch rounded-[35px] border border-[#1D8FFF] bg-[#22384C]">
            <div className="flex w-[41px] h-[41px] p-[11.31px_24.034px] flex-col justify-center items-center gap-[14.138px] rounded-[610.759px] bg-white">
              <span className="w-[9.897px] text-[#1D8FFF] text-center font-urbanist text-[20px] font-normal leading-[32.517px]">3</span>
            </div>
            <span className="text-white font-urbanist text-[20px] font-normal leading-[23px]">Campaign Setup</span>
          </div>
          <p className="self-stretch text-[#C1C7CD] text-center font-urbanist text-[14px] font-normal leading-[23px]">
        ...
        <div className="flex w-[226px] flex-col items-end gap-[18px] absolute left-[903px] top-[472px] h-[105px]">
          <div className="flex pr-[19px] justify-center items-center gap-[12px] self-stretch rounded-[35px] border border-[#4F6070] bg-[#22384C]">
            ...
            <span className="text-white font-urbanist text-[20px] font-normal leading-[23px]">Launch & Monitor</span>
          </div>
          <p className="self-stretch text-[#C1C7CD] text-center font-urbanist text-[14px] font-normal leading-[23px]">
        ...
        {/* Step 5 - Optimization */}
        <div className="flex w-[192px] flex-col items-center gap-[18px] absolute left-0 top-[626px] h-[128px]">
          <div className="flex pr-[19px] justify-center items-center gap-[12px] rounded-[35px] border border-[#1D8FFF] bg-[#22384C]">
            <div className="flex w-[41px] h-[41px] p-[11.31px_24.034px] flex-col justify-center items-center gap-[14.138px] rounded-[610.759px] bg-[#1D8FFF]">
              <span className="w-[9.897px] text-white text-center font-urbanist text-[20px] font-normal leading-[32.517px]">5</span>
            </div>
            <span className="text-white font-urbanist text-[20px] font-normal leading-[23px]">Optimization</span>
          </div>
          <p className="self-stretch text-[#C1C7CD] text-center font-urbanist text-[14px] font-normal leading-[23px]">
        ...
        {/* Step 6 - Reporting */}
        <div className="flex w-[183px] flex-col items-center gap-[18px] absolute left-[946px] top-[741px] h-[105px]">
          <div className="flex pr-[19px] justify-center items-center gap-[12px] rounded-[35px] border border-[#1D8FFF] bg-[#22384C]">
            <div className="flex w-[41px] h-[41px] p-[11.31px_24.034px] flex-col justify-center items-center gap-[14.138px] rounded-[610.759px] bg-[#1D8FFF]">
              <span className="w-[9.897px] text-white text-center font-urbanist text-[20px] font-normal leading-[32.517px]">6</span>
            </div>
            <span className="text-white font-urbanist text-[20px] font-normal leading-[23px]">Reporting</span>
          </div>
          <p className="self-stretch text-[#C1C7CD] text-center font-urbanist text-[14px] font-normal leading-[23px]">
