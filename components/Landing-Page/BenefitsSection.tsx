...
export const BenefitsSection: React.FC = () => {
  return (
    <div className="hidden lg:block relative w-full max-w-[1440px] h-auto min-h-[600px] lg:h-[1046px] bg-[#0C0C0F] mx-auto">
      ...
      />
      <div 
        className="hidden lg:block absolute w-[464px] h-[403px] bg-[#2F98FF] opacity-63 rounded-full blur-[365px] pointer-events-none left-0 top-[254px]"
      />

      {/* Content Container */}
      <div 
        className="relative w-full max-w-[1128px] h-auto lg:h-[839px] mx-auto px-4 lg:px-0 py-8 lg:py-0"
        style={{ top: '0px' }}
      >
        <div className="flex flex-col items-start gap-8 lg:gap-[50px] w-full max-w-[1128px] h-auto lg:h-[839px]">
          
          {/* Header section */}
          <div className="flex flex-col items-start gap-6 w-full max-w-[550px]">
            
            {/* Badge */}
            <div className="flex items-center justify-center gap-1.5 px-2.5 py-[5px] w-full max-w-[167px] bg-[#12579C] rounded-[45px] shadow-[0_3px_1.1px_0_#FFF]">
            ...
            <div className="flex flex-col items-start gap-4 w-full max-w-[550px]">
              <h2 className="h-auto lg:h-[116px] text-[#E8F4FF] font-urbanist text-xl md:text-3xl lg:text-[50px] font-bold leading-[24px] md:leading-[36px] lg:leading-[57px] w-full max-w-[550px]">
                Your Page, Designed With Purpose
              </h2>
              <p className="text-[#EBEDEF] font-urbanist text-sm md:text-base font-normal leading-[18px] md:leading-[23px] w-full max-w-[550px]">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-end gap-8 lg:gap-[73px] w-full max-w-[1128px]">
            
            {/* Left side - Performance metrics */}
            <div className="flex flex-col items-start gap-4 lg:gap-[21px] w-full max-w-[480px]">
              
              {/* Dashboard mockup */}
              <svg className="h-[60px] lg:h-[103px] w-full max-w-[480px] rounded-[11px]" viewBox="0 0 480 103" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex flex-col items-center gap-6 lg:gap-10 w-full max-w-[480px]">
                <div className="flex flex-col items-center gap-4 lg:gap-[23px] w-full max-w-[480px]">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-x-[77px] lg:gap-y-9 w-full max-w-[480px]">
                    ...
                    <div className="flex flex-col items-center gap-[27px] w-[198px] px-[11px] py-3.5 rounded-[11px]">
                      <div className="flex flex-col justify-center items-center gap-1.5">
                        <div className="flex justify-center items-center gap-2 w-[76px]">
                          ...
                          <span className="text-white font-urbanist text-lg lg:text-2xl font-semibold leading-[23px] capitalize">94%</span>
                        </div>
                    ...
                    {/* CRO Rating */}
                    <div className="flex flex-col items-center gap-4 lg:gap-[27px] w-full max-w-[198px] px-[11px] py-3.5 rounded-[11px]">
                      <div className="flex flex-col justify-center items-center gap-1.5">
                        <div className="flex justify-center items-center gap-2 w-full max-w-[76px]">
                          <svg className="w-[18px] h-[18px]" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <span className="text-white font-urbanist text-lg lg:text-2xl font-semibold leading-[23px] capitalize">87%</span>
                        </div>
                        <span className="text-white text-center font-urbanist text-sm font-normal leading-[23px] capitalize">CRO Rating</span>
                      </div>
                      <svg className="h-[0.5px] w-full max-w-[182px]" viewBox="0 0 182 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5 5H177.5" stroke="#D0D5DD" strokeOpacity="0.32" strokeWidth="9" strokeLinecap="round"/>
                    ...
                    <div className="flex flex-col items-center gap-4 lg:gap-[27px] w-full max-w-[198px] px-[11px] py-3.5 rounded-[11px]">
                      <div className="flex flex-col justify-center items-center gap-1.5">
                        <div className="flex justify-center items-center gap-2 w-full max-w-[76px]">
                          ...
                          <span className="text-white font-urbanist text-lg lg:text-2xl font-semibold leading-[23px] capitalize">92%</span>
                        </div>
                        <span className="text-white text-center font-urbanist text-sm font-normal leading-[23px] capitalize">Mobile Score</span>
                      </div>
                      <svg className="h-[0.5px] w-full max-w-[182px]" viewBox="0 0 182 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex flex-col items-center gap-4 lg:gap-[27px] w-full max-w-[198px] px-[11px] py-3.5 rounded-[11px]">
                      <div className="flex flex-col justify-center items-center gap-1.5">
                        <div className="flex justify-center items-center gap-2 w-full max-w-[76px]">
                          ...
                          <span className="text-white text-center font-urbanist text-lg lg:text-2xl font-semibold leading-[23px] capitalize">89%</span>
                        </div>
                ...
                <div className="flex flex-col items-center gap-4 w-full max-w-[284px]">
                  <h3 className="text-white text-center font-urbanist text-lg lg:text-xl font-medium leading-[23px] capitalize w-full max-w-[284px]">
            ...
            <div className="flex flex-col items-start gap-6 lg:gap-9 w-full max-w-[575px]">
              
              {/* Benefits card */}
              <div className="flex flex-col justify-center items-start gap-6 px-4 lg:px-[33px] py-6 lg:py-8 w-full max-w-[575px] bg-white rounded-[17px]">
                <div className="flex flex-col justify-center items-start gap-6 lg:gap-[38px] w-full max-w-[509px]">
                  
                  {/* Benefits list */}
                  <div className="flex flex-col items-start gap-3 w-full max-w-[509px]">
                    
                    {/* Benefit 1 */}
                    <div className="flex items-center gap-3 lg:gap-[19px] w-full max-w-[509px]">
                      ...
                      <span className="text-[#132A40] font-urbanist text-sm md:text-lg font-medium leading-[20px] md:leading-[23px] capitalize">
        ...
        {/* Connecting line */}
        <svg 
          className="hidden lg:block absolute w-[271px] h-[333px] pointer-events-none"
