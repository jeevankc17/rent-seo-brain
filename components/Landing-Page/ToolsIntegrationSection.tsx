...
const testimonialData = [
  ...
  },
  {
    ...
    name: "Michael Chen",
    title: "Ceo, growthlab",
    avatar: "/LP/ca/ellipse-1670-1.svg",
  },
  {
    id: 3,
    rating: 5,
    ...
    avatar: "/LP/ca/ellipse-1670-2.svg",
  },
];
...
const TestimonialCard = ({
  ...
  return (
    <article className="flex flex-col w-full max-w-[348px] items-start gap-[15px] px-4 lg:px-[17px] py-5 lg:py-[22px] relative bg-neutral-0 rounded-[23px] border border-solid border-primary-50 shadow-[0px_4px_19.3px_#2e97ff29]">
      <StarRating rating={rating} />

      <blockquote className="relative self-stretch [font-family:'Urbanist',Helvetica] font-normal text-neutral-300 text-xs lg:text-sm tracking-[0] leading-[22px] lg:leading-[26px]">
        "{testimonial}"
      </blockquote>

      <div className="inline-flex items-center gap-3.5 relative flex-[0_0_auto]">
        <img
          className="relative w-12 lg:w-[60px] h-12 lg:h-[60px] object-cover rounded-full"
          alt={`${name} profile picture`}
          src={avatar}
        />

        <div className="flex flex-col w-full max-w-[202px] items-start gap-0.5 relative">
          <cite className="relative self-stretch mt-[-1.00px] [font-family:'Urbanist',Helvetica] font-medium text-neutral-900 text-sm lg:text-base tracking-[0] leading-[22px] lg:leading-[26px] not-italic">
            {name}
          </cite>

          <div className="relative self-stretch [font-family:'Urbanist',Helvetica] font-normal text-neutral-200 text-xs lg:text-sm tracking-[0] leading-[20px] lg:leading-[26px]">
            {title}
          </div>
        </div>
      </div>
    ...
    <section className="flex flex-col w-full max-w-[1128px] items-center gap-8 lg:gap-[50px] relative flex-[0_0_auto] px-4 lg:px-0 mx-auto">
      <header className="flex flex-col w-full max-w-[633px] h-auto lg:h-[168px] items-center gap-4 relative">
        <div className="flex w-auto items-center justify-center gap-1.5 px-2.5 py-[5px] relative flex-[0_0_auto] bg-primary-50 rounded-[45px] border border-solid border-primary-300">
          ...
          <span className="relative w-fit mt-[-1.00px] [font-family:'Urbanist',Helvetica] font-medium text-primary-300 text-xs lg:text-sm tracking-[0] leading-[18px] lg:leading-[23px] whitespace-nowrap">
            Client Success Stories
          </span>
        </div>

        <div className="flex flex-col w-full max-w-[629px] h-auto lg:h-[119px] items-center gap-4 relative">
          <h2 className="relative w-full max-w-[641px] mt-[-1.00px] [font-family:'Urbanist',Helvetica] font-bold text-primary-500 text-3xl lg:text-[50px] text-center tracking-[0] leading-[40px] lg:leading-[57px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-[43px] relative self-stretch w-full flex-[0_0_auto]">
