     ...
     <div className="flex w-full max-w-[702px] flex-col justify-center items-center gap-4 lg:gap-5">
      ...
      <div className="flex w-full max-w-[630px] flex-col justify-center items-center gap-3 lg:gap-4">
       ...
       <p className="w-full max-w-[640px] text-grey-200 text-center text-sm lg:text-base font-medium leading-[20px] lg:leading-[23px] font-sans">
        From keyword research to link building, get actionable advice and case studies to grow your organic reach.
       </p>
      </div>
     </div>
     ...
     <div className="flex w-full lg:w-[514px] h-auto lg:h-[310px] flex-col items-start gap-6 lg:gap-[39px] flex-shrink-0 ">
      ...
      <div className="flex h-auto lg:h-[224px] flex-col items-start gap-2 lg:gap-2 flex-shrink-0 w-full">
       <div className="flex flex-col items-start gap-2 lg:gap-[9px] w-full">
        ...
        <p className="w-full text-grey-400 text-[12px] lg:text-[14px] font-medium leading-[18px] lg:leading-[23px] font-sans">
         To improve your local search rankings and attract more customers in your area, start by optimizing your Google Business Profile (GBP). Claim and verify your listing, ensuring your business name, address, and phone number (NAP) are accurate and consistent. Choose the most relevant business categories, write a keyword-rich description, and upload high-quality images of your storefront,{" "}
       ...
       <div className="flex items-center gap-[6px] mt-2">
        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
         <path d="M8.0026 15.1668C11.6845 15.1668 14.6693 12.1821 14.6693 8.50016C14.6693 4.81826 11.6845 1.8335 8.0026 1.8335C4.32071 1.8335 1.33594 4.81826 1.33594 8.50016C1.33594 12.1821 4.32071 15.1668 8.0026 15.1668Z" stroke="#8D8D8D" strokeWidth="1.61538" strokeLinecap="round" strokeLinejoin="round"/>
         <path d="M8 4.5V8.5L10.6667 9.83333" stroke="#8D8D8D" strokeWidth="1.61538" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ...
      <div className="flex items-center justify-between w-full">
       ...
       <div className="flex w-[32px] lg:w-[41px] h-[32px] lg:h-[41px] p-2 lg:p-[10px] justify-center items-center gap-2 rounded-full border border-grey-75 bg-grey-50">
        <svg width="20" height="20" className="lg:w-6 lg:h-6" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
         <path d="M7.5 17.5L17.5 7.5" stroke="#1D8FFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
         <path d="M7.5 7.5H17.5V17.5" stroke="#1D8FFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
       </div>
      </div>
     </div>
