...
export const ContactTestimonial: React.FC<TestimonialProps> = ({
  ...
  return (
    <section className="relative w-full h-auto lg:h-[640px] ">
      <div className="max-w-[1128px] mx-auto px-4 md:px-8 lg:px-0 w-full">
        <div className="relative w-full h-auto lg:h-[640px] bg-neutral-900 rounded-[20px] lg:rounded-[50px] overflow-hidden">
