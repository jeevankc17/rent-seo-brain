        ...
        <div className="flex w-full max-w-[565px] flex-col items-center gap-4">
          ...
          <div className="flex h-auto flex-col items-center gap-4 self-stretch">
            ...
            <p className="w-full max-w-[565px] text-[#6A7986] text-center font-urbanist text-sm md:text-base font-medium leading-[20px] lg:leading-[23px]">
              Whether you have questions, need support, or want to get started —
              we're here to help.
            </p>
          </div>
        </div>
        ...
        <div className="w-full px-4 md:px-8 lg:px-[92px] py-8 lg:py-[60px] rounded-[29px] border border-[#E9E9E9] bg-white shadow-[0_4px_35.3px_0_rgba(67,162,255,0.07)]">
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-[33px]">
            ...
            <div className="flex py-[19px] px-5 items-center gap-[10px] rounded-[5px] border border-[#D2D2D2] bg-[#FAFAFA] shadow-[0_1px_44.2px_0_rgba(0,129,255,0.20)]">
              ...
              >
                <g clipPath="url(#clip0_1562_7939)">
                  <path
                    d="M16.5 21V19C16.5 17.9391 16.0786 16.9217 15.3284 16.1716C14.5783 15.4214 13.5609 15 12.5 15H5.5C4.43913 15 3.42172 15.4214 2.67157 16.1716C1.92143 16.9217 1.5 17.9391 1.5 19V21"
                    stroke="#1D8FFF"
                    strokeWidth="2"
                    strokeLinecap="round"
            ...
            <div className="flex py-[19px] px-5 items-center gap-[10px] rounded-[5px] border border-[#D2D2D2] bg-[#FAFAFA] shadow-[0_1px_44.2px_0_rgba(0,129,255,0.20)]">
              ...
              >
                <path
                  d="M22.5 16.92V19.92C22.5009 20.1982 22.4156 20.4703 22.2556 20.6999C22.0955 20.9295 21.868 21.1058 21.604 20.205C21.269 21.004 20.728 21.6917 20.0443 22.1843C19.3606 22.6769 18.5634 22.9546 17.745 22.985C15.1247 23.105 12.5309 22.5114 10.25 21.265C7.233 19.584 4.778 16.943 3.5 13.75C2.222 10.557 2.125 6.967 3.5 3.73503C3.715 3.14703 4.5 2.73503 5 3.23503L7.5 5.73503C8.065 6.30003 8.271 7.13603 7.9 7.83503C7.572 8.45403 7.3 9.10203 7.09 9.77003C6.923 10.315 7.03 10.903 7.5 11.265L9.5 13.265C10.837 12.399 12.15 11.5 13.5 10.735C14.098 10.4 14.715 10.428 15.22 10.735L17.5 12.235C18.074 12.566 18.64 12.5 19.11 12.235C19.777 11.86 20.425 11.445 21.045 11.075C21.744 10.659 22.58 10.866 23.145 11.43L24.5 12.735C25.145 13.38 24.71 14.32 24.71 14.32C24.71 14.32 23.5 15.23 22.5 16.92Z"
                  stroke="#1D8FFF"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <div className="flex py-[19px] px-5 items-center gap-[10px] rounded-[5px] border border-[#D2D2D2] bg-[#FAFAFA] shadow-[0_1px_44.2px_0_rgba(0,129,255,0.20)]">
              ...
              >
                <path
                  d="M4.5 4H20.5C21.6046 4 22.5 4.89543 22.5 6V18C22.5 19.1046 21.6046 20 20.5 20H4.5C3.39543 20 2.5 19.1046 2.5 18V6C2.5 4.89543 3.39543 4 4.5 4Z"
                  stroke="#1D8FFF"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <div className="flex py-[19px] px-5 items-center gap-[10px] rounded-[5px] border border-[#D2D2D2] bg-[#FAFAFA] shadow-[0_1px_44.2px_0_rgba(0,129,255,0.20)]">
              ...
              >
                <path
                  d="M21.5 11.5C21.5 13.76 20.5 15.75 19 17.25M11.5 21C15.9183 21 19.5 17.4183 19.5 13C19.5 8.58172 15.9183 5 11.5 5C7.08172 5 3.5 8.58172 3.5 13C3.5 17.5228 7.08172 21 11.5 21Z"
                  stroke="#1D8FFF"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <div className="flex py-[19px] px-5 items-center gap-[10px] rounded-[5px] border border-[#D2D2D2] bg-[#FAFAFA] shadow-[0_1px_44.2px_0_rgba(0,129,255,0.20)]">
              ...
              >
                ...
                />
                <path
                  d="M12.5 2C15.0013 4.73835 16.4228 8.29203 16.5 12C16.4228 15.708 15.0013 19.2616 12.5 22C9.99872 19.2616 8.57725 15.708 8.5 12C8.57725 8.29203 9.99872 4.73835 12.5 2Z"
                  stroke="#1D8FFF"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <div className="col-span-1 lg:col-span-2 flex flex-col w-full h-32 lg:h-[195px] rounded-[5px] border border-[#D2D2D2] bg-[#FAFAFA] shadow-[0_1px_44.2px_0_rgba(0,129,255,0.20)] p-5">
              <div className="flex items-center gap-[10px] mb-2">
                ...
                <span className="text-[#6A7986] font-urbanist text-sm font-medium">
                  Comments
                </span>
              </div>
              <textarea
