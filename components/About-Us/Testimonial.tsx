                        ...
                        <div className="flex flex-col w-[177px] items-center gap-5 relative flex-[0_0_auto]">
                            ...
                            <div className="flex items-center relative self-stretch w-full flex-[0_0_auto]">
                                {avatars.map((avatar, index) => (
                                    <img
                                        key={index}
                                        className={`relative w-[40.16px] h-[40.16px] mt-[-0.58px] mb-[-0.58px] ${index === 0 ? "ml-[-1.08px]" : "-ml-1"} ${index >= 2 ? "w-[41.22px] h-[41.22px] mt-[-1.11px] mb-[-1.11px]" : ""}`}
                                        alt={`Customer avatar ${index + 1}`}
                                        src={avatar}
                                    />
                                ))}

                                <div className="relative w-[41.22px] h-[41.22px] mt-[-1.11px] mb-[-1.11px] mr-[-1.11px] -ml-1 bg-neutral-0 rounded-[88.64px] border-[1.11px] border-solid border-[#f8f8f9]">
