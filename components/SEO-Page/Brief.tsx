  ...
  return (
    <div className="flex flex-col lg:flex-row lg:items-end gap-6 lg:gap-6 px-4 lg:px-0 relative mx-[156px] ">
      ...
      <div className="flex lg:hidden flex-col sm:flex-row gap-4 w-full justify-center mt-8">
        ...
        {/* Mobile Stats Card - Brand Awareness */}
        <div className="inline-flex p-4 items-end gap-3 rounded-[20px] border border-black bg-[#F8F9F9] shadow-[0_4px_0_0_#FF9800] w-[200px] h-[80px]">
          <div className="flex w-[40px] h-[40px] justify-center items-center gap-[8.125px] rounded-[81.25px] bg-[rgba(216,253,95,1)] relative">
            <svg
              className="w-5 h-5 flex-shrink-0 relative"
              width="24"
              height="24"
