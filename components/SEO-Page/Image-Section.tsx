...
export default function ImageSection() {
  return (
    <div className="hidden lg:flex relative w-full max-w-[1118px] h-auto lg:h-[639px] mx-4 lg:mx-[160.82px] flex-shrink-0">
      {/* Left Section - Phone with gradient background */}
      <div className="relative lg:absolute left-0 top-0 flex w-full lg:w-[552px] h-auto lg:h-[639px] pt-[1px] flex-col justify-center items-center flex-shrink-0 mb-8 lg:mb-0">
        <div className="relative lg:absolute left-0 top-[1px] w-full lg:w-[552px] h-auto lg:h-[638px] flex-shrink-0">
          {/* Gradient Background */}
          <div
            className="absolute left-0 top-[120px] sm:top-[180px] lg:top-[242px] w-full lg:w-[552px] h-[200px] sm:h-[300px] lg:h-[396px] flex-shrink-0 rounded-[15px]"
            style={{
          ...
          {/* Logo/Icon Container */}
          <div className="absolute left-[50px] sm:left-[80px] lg:left-[131px] top-[50px] sm:top-[75px] lg:top-[101px] inline-flex h-[40px] sm:h-[50px] lg:h-[63px] px-[0.477px] py-[8.68px_0px_7.629px_26.18px] justify-end items-center flex-shrink-0 w-[60px] sm:w-[75px] lg:w-[88px]">
            <img
          ...
          {/* Phone Image */}
          <img
            className="absolute left-[20px] sm:left-[45px] lg:left-[71px] top-[60px] sm:top-[85px] lg:top-[110px] w-[250px] sm:w-[330px] lg:w-[410px] h-[320px] sm:h-[424px] lg:h-[528px] flex-shrink-0"
      ...
      <div className="relative lg:absolute left-0 lg:left-[602px] top-0 lg:top-[57px] w-full lg:w-[516px] h-auto lg:h-[546px] flex-shrink-0">
        {/* Background Image */}
        <img
          className="absolute left-0 top-0 w-full lg:w-[516px] h-auto lg:h-[582px] flex-shrink-0"
        ...
        <div
          className="absolute left-[20px] sm:left-[30px] lg:left-[41px] top-[40px] sm:top-[60px] lg:top-[87px] flex w-[calc(100%-40px)] sm:w-[calc(100%-60px)] lg:w-[423px] h-auto lg:h-[484px] px-[10px] sm:px-[15px] lg:px-[17.85px] py-[5px] sm:py-[6px] lg:py-[7.65px] flex-col items-center gap-[20px] sm:gap-[25px] lg:gap-[31.874px] flex-shrink-0 bg-white"
          style={{
        ...
        >
          {/* Header */}
          <div className="flex h-auto lg:h-[21.675px] justify-between items-center flex-shrink-0 self-stretch py-2 lg:py-0">
            <div className="flex items-center gap-[10.2px]">
              ...
              <div
                className="text-center font-urbanist text-sm lg:text-[17.85px] font-semibold"
                style={{ color: "#4F6070" }}
              >
                Live SEO Demo
              </div>
            ...
            <div
              className="text-center font-urbanist text-xs lg:text-[15.3px] font-medium"
              style={{ color: "#4F6070" }}
            >
              2:23:24AM
            </div>
          ...
          {/* Main Content */}
          <div className="flex flex-col items-center gap-[20px] lg:gap-[36.974px] self-stretch">
            {/* Counter Section */}
            <div className="flex flex-col justify-center items-center gap-[5.1px] self-stretch">
              <div className="flex w-full lg:w-[387.591px] h-auto lg:h-[28.049px] pb-[0.049px] justify-center items-center">
                <div
                  className="flex-1 text-center font-urbanist text-lg lg:text-[22.949px] font-semibold w-full lg:w-[388px] h-auto lg:h-[28px]"
                  style={{ color: "#1D8FFF" }}
                >
                  11,345
                </div>
              ...
              <div
                className="self-stretch text-center font-urbanist text-sm lg:text-[15.3px] font-medium"
                style={{ color: "#7B7B7B" }}
              >
            ...
            {/* Progress Steps */}
            <div className="flex flex-col items-start gap-[10px] lg:gap-[15.3px] self-stretch">
              {/* Crawling Step */}
              <div
                className="flex px-[10px] lg:px-[16.575px] py-[10px] lg:py-[15.3px] flex-col justify-center items-start gap-[8px] lg:gap-[10.2px] self-stretch rounded-[7.65px] bg-white"
              ...
              >
                <div className="flex flex-col justify-center items-start gap-[5.1px] self-stretch">
                  <div className="flex items-center gap-[10.2px]">
                    ...
                    <div
                      className="text-center font-urbanist text-sm lg:text-[15.3px] font-medium"
                      style={{ color: "#132A40" }}
                    >
                      Crawling
                    </div>
                  ...
                  <div
                    className="self-stretch font-urbanist text-xs lg:text-[15.3px] font-medium"
                    style={{ color: "#5B6B7A" }}
                  >
                ...
                <svg
                  className="w-full lg:w-[349.98px] h-0"
              ...
              >
                ...
                <svg
                  className="w-full lg:w-[274.119px] h-0"
              ...
              >
                ...
                <svg
                  className="w-full lg:w-[175.946px] h-0"
        ...
        {/* Status Bar */}
        <svg
          className="absolute left-[40px] sm:left-[60px] lg:left-[83px] top-[20px] sm:top-[35px] lg:top-[51px] flex w-[calc(100%-80px)] sm:w-[calc(100%-120px)] lg:w-[360px] justify-between items-center h-[11px]"
          width="361"
          height="11"
          viewBox="0 0 361 11"
          fill="none"
