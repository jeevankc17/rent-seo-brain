  ...
  return (
    <div className={`hidden lg:flex w-full max-w-[1128px] mx-auto flex-col justify-center items-center gap-8 relative px-4 py-8 lg:gap-[50px] lg:px-0 lg:py-0 ${className}`}>
      ...
      <div className="flex w-full max-w-[565px] flex-col items-center gap-3 relative lg:gap-4">
        ...
        <div className="flex h-auto flex-col items-center gap-3 self-stretch relative lg:h-[176px] lg:gap-4">
          <h2 className="self-stretch text-[#12579C] text-center font-urbanist text-xl font-bold leading-[24px] md:text-3xl lg:text-[50px] lg:leading-[57px]">
      ...
      {/* Main Content Cards */}
      <div className="flex flex-col items-start gap-12 self-stretch relative lg:gap-[78px]">
        <div className="flex flex-col justify-center items-center gap-8 self-stretch relative lg:flex-row lg:gap-5">
          {/* Lead Based Card */}
          <div className="flex w-full p-6 justify-center items-center gap-[10px] rounded-[14px] bg-white shadow-[0_4px_8.6px_8px_rgba(0,132,255,0.09)] relative lg:w-auto lg:p-[32px_29px]">
            <div className="flex w-full max-w-[494px] flex-col justify-center items-center gap-8 relative lg:gap-[45px]">
              {/* Industry Cards Visualization */}
              <div className="w-full h-auto min-h-[250px] relative overflow-hidden lg:w-[494px] lg:h-[331px]">
                {/* Main Card Container */}
                <div className="w-full h-full relative">
                  <div className="w-full h-full rounded-[20px] border border-[#F8F9FA] bg-white shadow-[0_4px_20px_0_rgba(238,238,238,0.50)]" />
                </div>
                ...
                <div className="w-full h-auto p-4 space-y-3 relative rounded-[13px] bg-white shadow-[0_4px_8.9px_12px_rgba(0,132,255,0.16)] lg:w-[384px] lg:h-[244px] lg:absolute lg:left-[53px] lg:top-[39px] lg:p-0 lg:space-y-0">
                  ...
                  <div className="relative w-full h-auto inline-flex p-2 items-center gap-2 rounded-[20px] bg-[#F8A02C] shadow-[0_4px_12px_0_rgba(0,132,255,0.35)] lg:absolute lg:left-[192px] lg:top-[80px] lg:w-[265px] lg:h-[83px] lg:p-[9.075px_18.151px] lg:gap-[9.075px] lg:rounded-[25.411px]">
                    ...
                    <div className="flex flex-1 flex-col items-start lg:w-[174.247px]">
                      <div className="text-[#FAFBFB] font-urbanist text-sm font-semibold leading-[20px] lg:text-[16.553px] lg:leading-[27.226px]">
                        Home & Local Services
                      </div>
                      <div className="w-full text-[#E9E9E9] font-urbanist text-xs font-medium leading-[16px] lg:w-[183.322px] lg:text-[14.521px] lg:leading-[18.151px]">
                  ...
                  <div className="relative w-full h-auto inline-flex p-2 items-center gap-2 rounded-[20px] bg-white shadow-[0_4px_12px_0_rgba(0,132,255,0.35)] lg:absolute lg:left-[-103px] lg:top-[34px] lg:w-[265px] lg:h-[83px] lg:p-[9.075px_18.151px] lg:gap-[9.075px] lg:rounded-[25.411px]">
                    ...
                    <div className="flex flex-1 flex-col items-start lg:w-[174.247px]">
                      <div className="text-[#071F36] font-urbanist text-sm font-semibold leading-[20px] lg:text-[16.553px] lg:leading-[27.226px]">
                        Education
                      </div>
                      <div className="w-full text-[#7B7B7B] font-urbanist text-xs font-medium leading-[16px] lg:w-[183.322px] lg:text-[14.521px] lg:leading-[18.151px]">
              ...
              {/* Lead Based Section */}
              <div className="flex flex-col items-start gap-6 self-stretch relative lg:gap-[38px]">
                <div className="flex flex-col items-start gap-3 self-stretch relative lg:gap-4">
                  <h3 className="self-stretch text-[#071F36] font-urbanist text-lg font-semibold leading-[22px] lg:text-[28px] lg:leading-[23px]">
                    Lead Based
                  </h3>
              ...
              <div className="w-full h-auto min-h-[250px] shadow-[0_4px_28.1px_0_rgba(0,0,0,0.10)] relative lg:w-[494px] lg:h-[331px]">
                ...
                <div className="w-full h-auto p-4 absolute left-0 top-0 lg:w-[494px] lg:h-[61px] lg:p-0">
                  <div className="absolute left-4 top-6 lg:left-[15px] lg:top-[24px]">
                    <span className="text-[#05004E] font-urbanist text-lg font-bold leading-[28px] lg:text-[20px] lg:leading-[32px]">
                      Sales
                    </span>
                  </div>
                </div>
        ...
        {/* Statistics Section */}
        <div className="grid grid-cols-2 gap-4 self-stretch relative lg:flex lg:justify-center lg:items-center lg:gap-[38px]">
          <div className="flex w-full p-4 flex-col justify-center items-center gap-4 rounded-[13px] border border-[#E8F4FF] bg-[rgba(232,244,255,0.18)] relative lg:w-[253px] lg:p-[22px_34px] lg:gap-[21px]">
            <span className="self-stretch text-[#1D8FFF] text-center font-urbanist text-lg font-semibold leading-[22px] lg:text-[24px] lg:leading-[26px]">
              25+
            </span>
            <span className="w-full text-[#7B7B7B] text-center font-urbanist text-sm font-medium leading-[20px] lg:w-[125px] lg:text-[18px] lg:leading-[26px]">
              Industries Served
            </span>
          </div>
          <div className="flex w-full p-4 flex-col justify-center items-center gap-4 rounded-[13px] border border-[#E8F4FF] bg-[rgba(232,244,255,0.18)] relative lg:w-[253px] lg:p-[22px_34px] lg:gap-[21px]">
