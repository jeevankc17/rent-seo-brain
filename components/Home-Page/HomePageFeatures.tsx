...
export default function HomePageFeatures() {
  return (
    <section className="w-full flex justify-center py-[50px]">
      <div className="w-[1128px] flex flex-col items-center gap-[50px]">
        {/* Title Section */}
        <div className="w-[519px] h-[229px] flex flex-col items-center gap-4">
          {/* Tagline */}
          <div className="w-[181px] py-[5px] flex justify-center items-center gap-[6px] rounded-[45px] border border-[#1D8FFF] relative">
            <div className="flex w-[166px] py-[2px] px-2 items-center gap-[6px] flex-shrink-0 rounded-[45px] bg-[#1D8FFF]">
              ...
              <span className="text-white font-urbanist text-[14px] font-normal leading-[23px] capitalize">
                Why rent SEO Brain
              </span>
            </div>
          </div>
          ...
          <div className="h-[176px] flex flex-col items-center gap-4 flex-shrink-0 self-stretch">
            <h2 className="self-stretch text-[#12579C] text-center font-urbanist text-[50px] font-bold leading-[57px]">
              SEO That Works for You
            </h2>
            <p className="self-stretch text-[#6A7986] text-center font-urbanist text-[16px] font-normal leading-[23px]">
        ...
        <div className="flex items-center gap-6">
          {/* Left Column */}
          <div className="w-[552px] flex flex-col items-start gap-6">
            {/* Card 1: On-Demand Tools */}
            <div className="h-[452px] flex justify-center items-center self-stretch relative">
              <div className="w-[552px] h-[452px] rounded-[11px] bg-white shadow-[0_4px_57.3px_0_rgba(247,181,13,0.17)] absolute left-0 top-0">
                {/* Decorative dots */}
                ...
                <div className="absolute left-[18px] top-[27px] right-[18px] bottom-[27px] flex flex-col items-center gap-3 overflow-hidden">
                  {/* Tool Interface */}
                    ...
                    <div className="flex flex-col items-end gap-4 self-stretch">
                      <div className="flex flex-col items-center gap-[14px] self-stretch">
                        <div className="flex flex-col items-start gap-[14px] self-stretch">
                          ...
                          <div className="flex justify-between items-center self-stretch">
                            <span className="text-[#34475A] font-urbanist text-[12px] font-medium">Progress</span>
                            <span className="text-[#34475A] font-urbanist text-[12px] font-medium">50%</span>
                          </div>
                        </div>
                        ...
                        <div className="flex justify-center items-center gap-[17px] self-stretch">
                          <div className="flex flex-1 py-[6px] px-[17px] flex-col justify-center items-center gap-[9px] rounded-[6px] bg-[#E8F4FF]">
                            <span className="self-stretch text-[#12579C] text-center font-urbanist text-[16px] font-bold">50+</span>
                            <span className="self-stretch text-[#12579C] text-center font-urbanist text-[14px] font-normal">Tools Available</span>
                          </div>
                          <div className="flex flex-1 py-[6px] px-[17px] flex-col justify-center items-center gap-[9px] rounded-[6px] bg-[#E8F4FF]">
                            <span className="self-stretch text-[#12579C] text-center font-urbanist text-[16px] font-bold">49</span>
                            <span className="self-stretch text-[#12579C] text-center font-urbanist text-[14px] font-normal">User Rating</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex py-[6px] px-[16px] justify-center items-center gap-[8px] self-stretch rounded-[34px] bg-[#FAFAFA]">
                        <div className="flex flex-1 py-[6px] px-[8px] justify-center items-center gap-[6px] rounded-[32px] bg-[#1D8FFF]">
                          ...
                          <span className="text-white text-center font-urbanist text-[14px] font-medium">Keyword</span>
                        </div>
                        <div className="flex flex-1 py-[6px] px-[8px] justify-center items-center gap-[6px] rounded-[32px] border border-[#8D8D8D]">
                          ...
                          <span className="text-[#8D8D8D] text-center font-urbanist text-[14px] font-medium">Audit</span>
                        </div>
                        <div className="flex flex-1 py-[6px] px-[8px] justify-center items-center gap-[6px] rounded-[32px] border border-[#8D8D8D]">
                          <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <span className="text-[#8D8D8D] text-center font-urbanist text-[14px] font-medium">Backlink</span>
                        </div>
                      </div>
                    </div>

                    <span className="self-stretch text-[#8D8D8D] text-center font-urbanist text-[12px] font-normal">
                  ...
                  <div className="flex flex-col items-start gap-[4px] self-stretch px-2">
                    <span className="text-[#F78C01] font-urbanist text-[16px] font-bold">01</span>
                    <div className="flex flex-col items-start gap-[1px] self-stretch">
                      <h3 className="text-[#132A40] font-urbanist text-[20px] font-bold">On-Demand Tools</h3>
                      <p className="relative z-10 text-[#4F6070] font-urbanist text-[16px] font-normal">
            ...
            <div className="h-[432px] flex justify-center items-center self-stretch relative">
              <div className="w-[552px] h-[432px] rounded-[11px] bg-white shadow-[0_4px_57.3px_0_rgba(247,181,13,0.17)] absolute left-0 top-0">
                {/* Decorative dots */}
                ...
                <div className="absolute left-[25px] top-[25px] right-[25px] bottom-[25px] flex flex-col items-center gap-[25px] overflow-hidden">
                  {/* Pricing Interface */}
                  <div className="flex flex-col items-start gap-2 self-stretch">
                    <div className="flex py-0 px-6 justify-between items-center self-stretch rounded-[345px]">
                      <span className="text-[#12579C] text-center font-urbanist text-[14px] font-medium">View Features ( Free )</span>
                      <div className="flex py-[5px] px-[10px] justify-center items-center gap-[10px] rounded-[27px] border border-[#00B45C] bg-[rgba(0,180,92,0.16)]">
                        <span className="text-[#00B45C] text-center font-urbanist text-[12px] font-medium">4 included</span>
                      </div>
                    </div>
                    ...
                    <div className="flex py-[7px] px-0 flex-col items-center gap-[14px] self-stretch rounded-[9px] bg-[rgba(255,255,255,0.97)]">
                      <div className="flex justify-center items-center gap-[10px] self-stretch">
                        <span className="text-[#5B6B7A] text-center font-urbanist text-[14px] font-medium">Free</span>
                        ...
                        <span className="text-[#5B6B7A] text-center font-urbanist text-[14px] font-medium">Enterprise</span>
                      </div>
                      <div className="w-[122px] flex flex-col items-center gap-[7px]">
                        <span className="self-stretch text-[#12579C] text-center font-urbanist text-[18px] font-bold">Free</span>
                        <span className="self-stretch text-[#12579C] text-center font-urbanist text-[14px] font-normal">Basic Tools Included</span>
                      </div>
                    </div>

                    <div className="flex py-[10px] px-[10px] justify-center items-center gap-[10px] self-stretch rounded-[4px] bg-[#1D8FFF]">
                      <span className="text-white text-center font-urbanist text-[14px] font-medium">Compare All Plans</span>
                    </div>
                  </div>

                  {/* Content */}
                  <div className="flex flex-col items-start gap-[14px] self-stretch px-2">
                    <span className="text-[#F78C01] font-urbanist text-[16px] font-bold">03</span>
                    <div className="flex flex-col items-start gap-[6px] self-stretch">
                      <h3 className="text-[#132A40] font-urbanist text-[20px] font-bold">Affordable & Scalable</h3>
                      <p className="relative z-10 text-[#4F6070] font-urbanist text-[16px] font-normal">
          ...
          <div className="w-[552px] flex flex-col items-start gap-6">
            ...
            <div className="h-[300px] flex justify-center items-center self-stretch relative">
              <div className="w-[552px] h-[300px] rounded-[11px] bg-white shadow-[0_4px_57.3px_0_rgba(247,181,13,0.17)] absolute left-0 top-0">
                {/* Decorative dots */}
                ...
                <div className="absolute left-[21px] top-[27px] right-[21px] bottom-[27px] flex flex-col items-start gap-4 overflow-hidden">
                  {/* Chart/Image placeholder */}
                  <div className="h-[94px] self-stretch rounded-[8px] bg-gradient-to-r from-pink-200 to-purple-200"></div>

                  {/* Content */}
                  <div className="flex flex-col items-start gap-[14px] self-stretch px-2">
                    <span className="text-[#F78C01] font-urbanist text-[16px] font-bold">02</span>
                    <div className="flex flex-col items-start gap-[6px] self-stretch">
                      <h3 className="text-[#132A40] font-urbanist text-[20px] font-bold">Actionable Insights</h3>
                      <p className="text-[#4F6070] font-urbanist text-[16px] font-normal">
            ...
            <div className="h-[534px] flex justify-center items-center self-stretch relative">
              <div className="w-[552px] h-[534px] rounded-[11px] bg-white shadow-[0_4px_57.3px_0_rgba(247,181,13,0.17)] absolute left-0 top-0">
                ...
                <div className="absolute left-[25px] top-[36px] right-[25px] bottom-[36px] flex flex-col items-center gap-[40px] overflow-hidden">
                  {/* Performance Visual */}
                  <div className="w-[334.949px] h-[190.084px] shadow-[0_7.812px_80.075px_0_rgba(47,152,255,0.63)] relative">
                  ...
                  {/* Content */}
                  <div className="flex flex-col items-start gap-[14px] self-stretch px-2">
                    <span className="text-[#F78C01] font-urbanist text-[16px] font-bold">04</span>
                    <div className="flex flex-col items-start gap-[6px] self-stretch">
                      <h3 className="text-[#132A40] font-urbanist text-[20px] font-bold">Boost SEO Performance</h3>
                      <p className="text-[#4F6070] font-urbanist text-[16px] font-normal">
        ...
        <div className="flex justify-center items-center gap-[22px]">
          <div className="flex w-[265px] h-[50px] py-0 px-[3px] justify-end items-center gap-[10px] rounded-[45px] bg-[#1D8FFF] shadow-[0_4px_14.7px_0_rgba(47,152,255,0.63)]">
            <span className="text-white text-center font-urbanist text-[16px] font-medium leading-[23px] capitalize">
              Get Your SEO Audit Now
            </span>
            <div className="flex py-3 px-3 items-center gap-[10px] rounded-[34px] border border-[#A2D1FF] bg-[#E8F4FF]">
          ...
          <div className="flex w-[229px] h-[50px] py-[10px] px-[19px] justify-center items-center gap-[7px] rounded-[33px] border border-[#D2D2D2] bg-[#FAFAFA]">
