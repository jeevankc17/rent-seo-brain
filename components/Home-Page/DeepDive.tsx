...
export default function DeepDive() {
  return (
    <section className="w-full flex justify-center py-8">
      <div className="w-[1128px] h-[456px] relative bg-gradient-to-b from-[#43A2FF] via-[#43A2FF] to-white rounded-[19px] overflow-hidden">
        {/* Background blur elements */}
        <div className="w-[239px] h-[162px] absolute left-[-111px] top-[440px] bg-[#00B45C] rounded-full blur-[150px]" />
        <div className="w-[239px] h-[162px] absolute left-[971px] top-[456px] bg-[#00B45C] rounded-full blur-[150px]" />
        
        {/* Main content */}
        <div className="flex w-[773px] flex-col items-center gap-[49px] absolute left-[177px] top-[58px]">
          {/* Title section */}
          <div className="flex flex-col justify-center items-center gap-[18px] self-stretch">
            <div className="flex flex-col justify-center items-center gap-4 self-stretch">
              {/* Badge */}
              <div className="flex w-[252px] py-[5px] justify-center items-center gap-[6px] rounded-[45px] border border-[#F78C01]">
                <div className="flex w-[233px] py-[2px] px-2 justify-center items-center gap-[6px] flex-shrink-0 rounded-[45px] bg-[#FEF4E6]">
                  ...
                  <div className="text-[#F78C01] font-urbanist text-sm font-medium leading-[23px] capitalize">
              ...
              {/* Main heading */}
              <div className="self-stretch text-[#12579C] text-center font-urbanist text-[50px] font-bold leading-[57px]">
                Get a Deep Dive Into Your Website's SEO Health 
              </div>
            </div>
            
            {/* Description */}
            <div className="self-stretch text-[#4F6070] text-center font-urbanist text-base font-medium leading-[23px]">
          ...
          <div className="flex flex-col items-start gap-[18px] self-stretch">
            <div className="flex justify-center items-center gap-[17px] self-stretch">
              {/* Input field */}
              <div className="flex w-[546px] py-[18px] px-[30px] items-center gap-[11px] rounded-[32px] border border-[#E0E0E0] bg-[#FAFBFB]">
                ...
                <div className="text-[#8D8D8D] font-urbanist text-base font-medium leading-[23px] lowercase">
                  Enter your website URL (eg.example.com)
                </div>
              </div>
              
              {/* Button */}
              <div className="flex w-[207px] h-[60px] py-0 px-8 justify-center items-center gap-[10px] rounded-[45px] bg-[#1D8FFF] shadow-[0px_5px_14.7px_0px_rgba(47,152,255,0.63)]">
        ...
        <div className="flex w-[177px] items-center content-center gap-[3px] flex-wrap absolute left-[965px] top-[-26px] h-[69px]">
        ...
        <div className="flex w-[177px] items-center content-center gap-[3px] flex-wrap absolute left-[-62px] top-[221px] h-[69px]">
