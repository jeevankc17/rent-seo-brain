  ...
  return (
    <div className="flex w-[907px] h-[1766px] flex-col items-center gap-[50px] relative">
      ...
      <div className="flex w-[601px] flex-col justify-center items-center gap-4 relative">
        {/* Badge */}
        <div className="flex w-[203px] py-[5px] px-[10px] justify-center items-center gap-[6px] rounded-[45px] bg-[#12579C] relative">
          ...
          <div className="text-[#E8F4FF] font-urbanist text-[14px] font-medium leading-[23px] relative">
            Our Proven Process
          </div>
        </div>
        ...
        <div className="flex h-[176px] flex-col justify-center items-center gap-4 self-stretch relative">
          <div className="w-[593px] text-[#E8F4FF] text-center font-urbanist text-[50px] font-bold leading-[57px] relative">
            How We Turn Ideas Into ROI-Driven Content
          </div>
          <div className="text-[#EBEDEF] text-center font-urbanist text-[16px] font-normal leading-[23px] self-stretch relative">
      ...
      <div className="h-[1491px] flex-shrink-0 self-stretch relative">
        ...
        {/* Process Card 01 */}
        <div className="flex w-[345px] py-[33px] px-[22px] flex-col items-start gap-[-15px] rounded-[25px] bg-[rgba(36,50,64,0.46)] absolute left-[562px] top-0 h-[292px]">
        ...
        {/* Process Card 02 */}
        <div className="flex w-[345px] py-[33px] px-[22px] flex-col items-start gap-[-15px] rounded-[25px] bg-[rgba(36,50,64,0.46)] absolute left-[-15px] top-[300px] h-[292px]">
          <div className="w-[307px] text-[#22384C] font-urbanist text-[85px] font-bold leading-[55px] capitalize relative">
            02
          </div>
          <div className="flex w-[307px] flex-col items-start gap-6 relative">
