      ...
      <div className="relative flex flex-col items-center px-4 sm:px-8 lg:px-[157px] pt-8 lg:pt-[78px] pb-8 lg:pb-0 z-10">
        ...
        <div className="flex w-full max-w-[766px] flex-col justify-center items-center gap-6 lg:gap-11 mb-8 lg:mb-16">
          <div className="flex w-full max-w-[702px] flex-col justify-center items-center gap-3 lg:gap-5">
            ...
            <div className="flex items-center justify-start gap-2 lg:gap-[9px] h-8 lg:h-[33px] border border-white p-1 lg:p-[5px] rounded-[25px] lg:rounded-[45px]">
              <div className="flex items-start gap-[-6px] lg:gap-[-10.677px]">
                {[
                  ...
                  <div
                    key={imagePath}
                    className={`relative w-5 lg:w-[25px] h-5 lg:h-[25px] rounded-full overflow-hidden
                      ${
                        index > 0
                          ? "border border-grey-50 lg:border-[1.602px] -ml-[6px] lg:-ml-[10.677px]"
                          : ""
                      }`}
                  >
                    <Image
            ...
            <div className="flex w-full max-w-[630px] flex-col justify-center items-center gap-3 lg:gap-4">
              <h1 className="w-full text-center text-xl sm:text-3xl md:text-4xl lg:text-[50px] font-bold leading-[24px] sm:leading-[36px] md:leading-[46px] lg:leading-[57px] font-sans">
              ...
              <p className="w-full max-w-[640px] text-grey-200 text-center text-sm md:text-base lg:text-base font-medium leading-[18px] md:leading-[20px] lg:leading-[23px] font-sans px-4">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row justify-center items-stretch sm:items-center gap-3 lg:gap-[13px] w-full max-w-[520px] px-4">
            <button className="flex w-full sm:w-[200px] md:w-[240px] lg:w-[273px] h-[40px] lg:h-[50px] px-[3px] py-0 justify-center lg:justify-end items-center gap-2 lg:gap-[10px] rounded-[25px] lg:rounded-[45px] bg-primary-300 shadow-[0_4px_14.7px_0_rgba(47,152,255,0.63)]">
            ...
            <button className="flex w-full sm:w-[160px] md:w-[180px] lg:w-[220px] h-[40px] lg:h-[50px] px-3 lg:px-[19px] py-[8px] lg:py-[10px] justify-center items-center gap-2 lg:gap-[7px] rounded-[20px] lg:rounded-[33px] border border-grey-200 bg-grey-50">
