                        ...
                        <div className="flex flex-col w-[177px] items-center gap-5 relative flex-[0_0_auto]">
                            ...
                            <div className="flex items-center relative self-stretch w-full flex-[0_0_auto]">
                                {avatars.map((avatar, index) => (
                                    <img
                                        key={index}
                                        className={`relative w-[40.16px] h-[40.16px] mt-[-0.58px] mb-[-0.58px] ${index === 0 ? "ml-[-1.08px]" : "-ml-1"} ${index >= 2 ? "w-[41.22px] h-[41.22px] mt-[-1.11px] mb-[-1.11px]" : ""} rounded-full object-cover`}
                                ...
                                <div
                                  className="relative w-[41.22px] h-[41.22px] mt-[-1.11px] mb-[-1.11px] mr-[-1.11px] -ml-1 bg-neutral-0 rounded-full border-[1.11px] border-solid border-[#f8f8f9] flex items-center justify-center overflow-hidden"
                    ...
                    <div className="flex flex-col items-center gap-8 relative self-stretch w-full flex-[0_0_auto]">
                        <div className="flex flex-col items-center gap-4 relative self-stretch w-full flex-[0_0_auto]">
                            ...
                            <p className="relative w-[598px] [font-family:'Urbanist',Helvetica] font-medium text-[#ffffffb2] text-lg text-center tracking-[0] leading-[26.1px]">
                                Join 500+ businesses that increased their revenue by an average of 187% with our proven SEO + Landing Page system.
                            </p>
                        </div>
